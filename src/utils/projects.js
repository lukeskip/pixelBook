const projects = [
  {
    ...
    title: "Knobs",
    description:
      "Creé esta plataforma para conectar músicos independientes con productores y músicos profesionales para que estos últimos los aconsejen para hacer crecer su proyecto a cambio de un incentivo económico. La idea creativa es mía y desarrollé el diseño utilizando Adobe XD y desarrollé el sistema con PHP (Laravel)",
